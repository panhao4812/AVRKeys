...
#include "oddebug.h"
#include "../usbdevice.h"
const   PROGMEM uint8_t KeyboardReport[] = { /* USB report descriptor */
	...
	0x95, KEY_CODE_NUMBER,                    //   REPORT_COUNT 1(simultaneous keystrokes)
...
const PROGMEM uint8_t  RawReport[] =
{
	...
	0xA1, 0x01,//Collection (Application)
	0x09 ,0x75,//Usage (Vendor-Defined 118)
...
PROGMEM const char usbDescriptorConfiguration[] = {    /* USB configuration descriptor */
    ...
    0x07,          /* sizeof(usbDescrEndpoint) */
    0x05,  /* descriptor type = endpoint */
    RAW_ENDPOINT_OUT+0x00, /* IN endpoint number 1 */
    0x03,       /* attrib: Interrupt endpoint */
...
USB_PUBLIC usbMsgLen_t usbFunctionDescriptor(struct usbRequest *rq)
{
	...
	switch (rq->wValue.bytes[1]) {
		...
		switch (rq->wValue.bytes[0]) {
			...
			usbMsgPtr =(unsigned char *)(usbDescriptorConfiguration+9+25+9);
			len    =9;
			break;
			#endif
			#if RAW_ENABLE
			case RAW_INTERFACE:
			usbMsgPtr =(unsigned char *)( usbDescriptorConfiguration+9+25+25*MOUSE_ENABLE+9);
			len    = 9;
			break;
			#endif
		}
